...
Se agregó el script captura_rgb_profundidad.py, orientado a realizar pruebas iniciales de captura con la cámara Orbbec Astra+. Este avance permite iniciar la obtención de datos visuales del entorno, tanto en imagen RGB como en profundidad.
